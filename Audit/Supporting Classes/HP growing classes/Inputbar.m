...
#define RIGHT_BUTTON_SIZE 44
#define LEFT_BUTTON_SIZE 44
...
-(void)addTextView
{
  ...
  _textView = [[HPGrowingTextView alloc] initWithFrame:CGRectMake(LEFT_BUTTON_SIZE,
                                                                    5,
                                                                    size.width - LEFT_BUTTON_SIZE - RIGHT_BUTTON_SIZE - 5,
                                                                    size.height)];
...
-(void)addRightButton
{
    ...
    self.rightButton.imageEdgeInsets = UIEdgeInsetsMake(2.5, 2.5, 2.5, 2.5);
  //  [self.rightButton  :[UIColor blueColor] forState:UIControlStateNormal];
...
-(void)addLeftButton
{
    ...
    self.leftButton.imageEdgeInsets = UIEdgeInsetsMake(2.5, 0, 2.5, 0);
